    ...
    fn content() -> Markup {
        html! {
            div.jumbotron {
                ...
                p "At the reception venue (Panoramic Room at Pacific Tower) children can hang out right down the hall from the main room along with a licensed childcare provider."
                ...
                p "Please let us known on your RSVP how many children will be attending and reach out to Lillian or Alex if you have any questions."
            }
        }
    }
}